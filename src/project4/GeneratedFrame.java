...
//            generatedFrameDFromBC.getObjects().add(object5);
            ...
            for(int i=0; i<semanticNetwork.getABTransformations().size(); i++) {
                ...
                int transformationIndex = findBestCorrespondenceForTransformationsFrameB(semanticNetwork.getFrameB(), semanticNetwork.getABTransformations().get(i));
...
//            generatedFrameDFromBC.getObjects().add(object5);
            ...
            for(int i=0; i<semanticNetwork.getACTransformations().size(); i++) {
                ...
                int transformationIndex = findBestCorrespondenceForTransformationsFrameC(semanticNetwork.getFrameC(), semanticNetwork.getACTransformations().get(i));
                String shapeOfFrameDObject = generatedFrameDFromBC.getObjects().get(transformationIndex).getAttributes().get(0).getValue();
